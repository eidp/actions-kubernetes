...
|    `environment`    |                                                                                                                                                                  The environment to verify (e.g. development, staging, production).                                                                                                                                                                  |   No   |`development`|
...
|   `chart-version`   |                                                                   Specify the chart-version input in case you want to verify if a specific version of a Helm chart is up. If not provided, the action will succeed if any deployment is up in the namespace. This input only works when the `flux-resource` input is also provided.                                                                  |   No   |      ``     |
