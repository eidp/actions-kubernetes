...
|`flux-resource`       |The Flux resource path of the deployment to verify (e.g. helmreleases/my-release or kustomization/my-release).                                                                                                                                                                                                                                                                                         |Yes     |``     |
|`chart-version`       |Specify the chart-version input in case you want to verify if a specific version of a Helm chart is deployed.                                                                                                                                                                                                                                                                                          |No      |``     |
...
|`github-token`        |GitHub token for posting PR comments. Only posts comments if token is provided and running in PR context. Required permissions: contents:read, pull-requests:write, issues:write, deployments: write.                                                                                                                                                                                                  |No      |``     |
